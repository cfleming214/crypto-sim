...
const INITIAL_COINS: Coin[] = [
  ...
  { symbol: 'ZEC', name: "Zcash", price: 398.61, change24h: 4.0, marketCap: '$7B', volume: '$310M', history: [387.449,389.043,390.638,392.232,393.827,395.421,397.016,398.61] },
  { symbol: 'XMR', name: "Monero", price: 310.63, change24h: 0.1, marketCap: '$6B', volume: '$145M', history: [301.932,303.175,304.417,305.66,306.902,308.145,309.387,310.63] },
  { symbol: 'HBAR', name: "Hedera", price: 0.070638, change24h: -1.4, marketCap: '$3B', volume: '$50M', history: [0.0686601,0.0689427,0.0692252,0.0695078,0.0697903,0.0700729,0.0703554,0.070638] },
  { symbol: 'SUI', name: "Sui", price: 0.694035, change24h: 0.2, marketCap: '$3B', volume: '$286M', history: [0.674602,0.677378,0.680154,0.68293,0.685707,0.688483,0.691259,0.694035] },
  { symbol: 'CRO', name: "Cronos", price: 0.053739, change24h: -0.6, marketCap: '$2B', volume: '$8M', history: [0.0522343,0.0524493,0.0526642,0.0528792,0.0530941,0.0533091,0.053524,0.053739] },
  { symbol: 'TAO', name: "Bittensor", price: 205.25, change24h: -0.3, marketCap: '$2B', volume: '$126M', history: [199.503,200.324,201.145,201.966,202.787,203.608,204.429,205.25] },
  { symbol: 'ONDO', name: "Ondo", price: 0.312437, change24h: 0.3, marketCap: '$2B', volume: '$55M', history: [0.303689,0.304939,0.306188,0.307438,0.308688,0.309938,0.311187,0.312437] },
  { symbol: 'WLD', name: "Worldcoin", price: 0.412349, change24h: -3.0, marketCap: '$1B', volume: '$202M', history: [0.400803,0.402453,0.404102,0.405751,0.407401,0.40905,0.4107,0.412349] },
  { symbol: 'MNT', name: "Mantle", price: 0.428616, change24h: 0.7, marketCap: '$1B', volume: '$36M', history: [0.416615,0.418329,0.420044,0.421758,0.423473,0.425187,0.426902,0.428616] },
  { symbol: 'MORPHO', name: "Morpho", price: 1.92, change24h: 7.1, marketCap: '$1B', volume: '$17M', history: [1.86624,1.87392,1.8816,1.88928,1.89696,1.90464,1.91232,1.92] },
  { symbol: 'ETC', name: "Ethereum Classic", price: 7.01, change24h: -0.4, marketCap: '$1B', volume: '$32M', history: [6.81372,6.84176,6.8698,6.89784,6.92588,6.95392,6.98196,7.01] },
  { symbol: 'PEPE', name: "Pepe", price: 0.00000233, change24h: -0.8, marketCap: '$980M', volume: '$135M', history: [0.00000226476,0.00000227408,0.0000022834,0.00000229272,0.00000230204,0.00000231136,0.00000232068,0.00000233] },
  { symbol: 'QNT', name: "Quant", price: 65.73, change24h: 1.0, marketCap: '$956M', volume: '$10M', history: [63.8896,64.1525,64.4154,64.6783,64.9412,65.2042,65.4671,65.73] },
  { symbol: 'KAS', name: "Kaspa", price: 0.0299562, change24h: 5.9, marketCap: '$823M', volume: '$18M', history: [0.0291174,0.0292372,0.029357,0.0294769,0.0295967,0.0297165,0.0298363,0.0299562] },
  { symbol: 'RENDER', name: "Render", price: 1.53, change24h: -2.4, marketCap: '$793M', volume: '$38M', history: [1.48716,1.49328,1.4994,1.50552,1.51164,1.51776,1.52388,1.53] },
  { symbol: 'ALGO', name: "Algorand", price: 0.085545, change24h: -0.7, marketCap: '$765M', volume: '$32M', history: [0.0831497,0.0834919,0.0838341,0.0841763,0.0845185,0.0848606,0.0852028,0.085545] },
  { symbol: 'ENA', name: "Ethena", price: 0.074433, change24h: -5.2, marketCap: '$692M', volume: '$210M', history: [0.0723489,0.0726466,0.0729443,0.0732421,0.0735398,0.0738375,0.0741353,0.074433] },
  { symbol: 'JUP', name: "Jupiter", price: 0.205859, change24h: -2.1, marketCap: '$684M', volume: '$31M', history: [0.200095,0.200918,0.201742,0.202565,0.203389,0.204212,0.205036,0.205859] },
  { symbol: 'INJ', name: "Injective", price: 4.65, change24h: -1.8, marketCap: '$465M', volume: '$84M', history: [4.5198,4.5384,4.557,4.5756,4.5942,4.6128,4.6314,4.65] },
  { symbol: 'CAKE', name: "PancakeSwap", price: 1.32, change24h: -2.3, marketCap: '$426M', volume: '$32M', history: [1.28304,1.28832,1.2936,1.29888,1.30416,1.30944,1.31472,1.32] },
  { symbol: 'FET', name: "Artificial Superintelligence Alliance", price: 0.171301, change24h: -3.4, marketCap: '$386M', volume: '$52M', history: [0.166505,0.16719,0.167875,0.16856,0.169245,0.169931,0.170616,0.171301] },
  { symbol: 'VET', name: "VeChain", price: 0.00440803, change24h: -2.2, marketCap: '$379M', volume: '$11M', history: [0.00428461,0.00430224,0.00431987,0.0043375,0.00435513,0.00437277,0.0043904,0.00440803] },
  { symbol: 'BONK', name: "Bonk", price: 0.00000424, change24h: 1.0, marketCap: '$373M', volume: '$25M', history: [0.00000412128,0.00000413824,0.0000041552,0.00000417216,0.00000418912,0.00000420608,0.00000422304,0.00000424] },
  { symbol: 'JTO', name: "Jito", price: 0.754889, change24h: -8.5, marketCap: '$369M', volume: '$60M', history: [0.733752,0.736772,0.739791,0.742811,0.74583,0.74885,0.751869,0.754889] },
  { symbol: 'TIA', name: "Celestia", price: 0.389157, change24h: 2.2, marketCap: '$365M', volume: '$48M', history: [0.378261,0.379817,0.381374,0.38293,0.384487,0.386044,0.3876,0.389157] },
  { symbol: 'SEI', name: "Sei", price: 0.0497054, change24h: -0.3, marketCap: '$335M', volume: '$33M', history: [0.0483136,0.0485124,0.0487113,0.0489101,0.0491089,0.0493077,0.0495065,0.0497054] },
  { symbol: 'STX', name: "Stacks", price: 0.162221, change24h: -3.0, marketCap: '$300M', volume: '$5M', history: [0.157679,0.158328,0.158977,0.159625,0.160274,0.160923,0.161572,0.162221] },
  { symbol: 'CRV', name: "Curve DAO", price: 0.190043, change24h: -0.0, marketCap: '$290M', volume: '$22M', history: [0.184722,0.185482,0.186242,0.187002,0.187762,0.188523,0.189283,0.190043] },
  { symbol: 'PYTH', name: "Pyth Network", price: 0.0368116, change24h: 1.9, marketCap: '$290M', volume: '$22M', history: [0.0357809,0.0359281,0.0360754,0.0362226,0.0363699,0.0365171,0.0366644,0.0368116] },
  { symbol: 'XTZ', name: "Tezos", price: 0.206355, change24h: -2.5, marketCap: '$225M', volume: '$9M', history: [0.200577,0.201402,0.202228,0.203053,0.203879,0.204704,0.20553,0.206355] },
  { symbol: 'CFX', name: "Conflux", price: 0.0425032, change24h: 0.7, marketCap: '$222M', volume: '$4M', history: [0.0413131,0.0414832,0.0416532,0.0418232,0.0419932,0.0421632,0.0423332,0.0425032] },
  { symbol: 'FLOKI', name: "FLOKI", price: 0.00002216, change24h: 1.4, marketCap: '$214M', volume: '$17M', history: [0.0000215395,0.0000216282,0.0000217168,0.0000218054,0.0000218941,0.0000219827,0.0000220714,0.00002216] },
  { symbol: 'LDO', name: "Lido DAO", price: 0.250897, change24h: -0.1, marketCap: '$212M', volume: '$22M', history: [0.243872,0.244875,0.245879,0.246883,0.247886,0.24889,0.249893,0.250897] },
  { symbol: 'CHZ', name: "Chiliz", price: 0.0192452, change24h: 11.3, marketCap: '$201M', volume: '$65M', history: [0.0187063,0.0187833,0.0188603,0.0189373,0.0190142,0.0190912,0.0191682,0.0192452] },
  { symbol: 'STRK', name: "Starknet", price: 0.0295374, change24h: -1.0, marketCap: '$193M', volume: '$19M', history: [0.0287104,0.0288286,0.0289467,0.0290649,0.029183,0.0293012,0.0294193,0.0295374] },
  { symbol: 'GRT', name: "The Graph", price: 0.0177958, change24h: -0.2, marketCap: '$192M', volume: '$18M', history: [0.0172975,0.0173687,0.0174399,0.0175111,0.0175822,0.0176534,0.0177246,0.0177958] },
  { symbol: 'WIF', name: "dogwifhat", price: 0.173388, change24h: -3.9, marketCap: '$173M', volume: '$46M', history: [0.168533,0.169227,0.16992,0.170614,0.171307,0.172001,0.172694,0.173388] },
  { symbol: 'AXS', name: "Axie Infinity", price: 0.983918, change24h: -0.9, marketCap: '$171M', volume: '$20M', history: [0.956368,0.960304,0.96424,0.968175,0.972111,0.976047,0.979982,0.983918] },
  { symbol: 'ENS', name: "Ethereum Name Service", price: 4.12, change24h: -0.3, marketCap: '$168M', volume: '$10M', history: [4.00464,4.02112,4.0376,4.05408,4.07056,4.08704,4.10352,4.12] },
  { symbol: 'COMP', name: "Compound", price: 15.64, change24h: -1.1, marketCap: '$151M', volume: '$11M', history: [15.2021,15.2646,15.3272,15.3898,15.4523,15.5149,15.5774,15.64] },
];
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  // Prune ended/orphaned contest portfolios. A joined contest is only a real,
  // tradeable portfolio while it's live/open; once it ends (or its Competition
  // row was removed entirely), it shouldn't linger in the portfolio selector.
  //   • Anything in joinedTournamentIds is an isActive=true entry (loadJoined…
  //     filters out isActive=false), so finished RESULT rows (which back the
  //     win-count + unclaimed-rewards) are never touched here.
  //   • LEAVE_TOURNAMENT drops it from the local active-portfolio set (and falls
  ...
  useEffect(() => {
    ...
    const now = Date.now();
    const liveOrOpen = new Set(state.competitions.filter(c => c.status !== 'finished' && now < c.endAt).map(c => c.id));
    const present = new Set(state.competitions.map(c => c.id));
    const finished = new Set(state.finishedCompetitions.map(c => c.id));
    for (const id of state.joinedTournamentIds) {
      if (state.replayMeta[id]) continue;   // replays are managed separately
